...
from cesnet_tszoo.utils.constants import ID_TIME_COLUMN_NAME, TIME_COLUMN_NAME, TIME_DTYPE_PART, BASE_DATA_DTYPE_PART
    ...
    def __getitem__(self, batch_idx):
        ...
        if self.load_config.include_time:
            if self.load_config.time_format == TimeFormat.ID_TIME:
                data[BASE_DATA_DTYPE_PART][:, :, self.time_col_index] = self.load_config.time_period[ID_TIME_COLUMN_NAME]
