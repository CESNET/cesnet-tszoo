...
class CombinedInitializerDataset(InitializerDataset):
    ...
    def __init__(self, database_path: str, table_data_path: str, ts_id_name: str, ts_row_ranges: np.ndarray, time_period: np.ndarray,
        ...
        super(CombinedInitializerDataset, self).__init__(database_path, table_data_path, ts_id_name, time_period, features_to_take, indices_of_features_to_take_no_ids, default_values)
    ...
    def __getitem__(self, idx):
        ...
        return train_data, count_values
