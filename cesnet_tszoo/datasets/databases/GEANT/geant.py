...
import cesnet_tszoo.datasets.databases.GEANT.constants as geant_constants
from cesnet_tszoo.utils.enums import SourceType, AgreggationType, DatasetType


class GEANT(CesnetDatabase):
    """
    Dataset class for [GEANT][geant]. 
    ...
    source_types = geant_constants.SOURCE_TYPES
    aggregations = geant_constants.AGGREGATIONS
