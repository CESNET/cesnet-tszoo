...
class Abilene(CesnetDatabase):
    ...
    def get_dataset(cls, data_root: str, subset: Literal["matrix", "node", "node2node"],
        ...
        return super(Abilene, cls).get_dataset(data_root, subset, SourceType.BACKBONE_NETWORK, AgreggationType.AGG_5_MINUTES, dataset_type, check_errors, display_details)
