...
- API for downloading, configuring and loading all datasets from *Datasets* section. Each with various sources and aggregations. Check [dataset overview][overview-of-datasets] page for details about datasets.
